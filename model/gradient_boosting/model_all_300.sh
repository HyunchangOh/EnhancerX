#!/bin/bash
#SBATCH --job-name=GB_300
#SBATCH --output=outputGB300_%j.txt  # Save output to a file named output_<job_id>.txt
#SBATCH --error=errorGB300_%j.txt    # Save error messages to a file named error_<job_id>.txt
