...
model_save_dir = os.path.join(input_dir, 'gradient_boosting_leaf2', chr_folder)
...
def create_gb_model():
    model = GradientBoostingClassifier(n_estimators=100, random_state=42,min_samples_leaf=2)
    return model
