#!/bin/bash
#SBATCH --job-name=MLP1111
#SBATCH --output=output100_100_100_100_%j.txt  # Save output to a file named output_<job_id>.txt
#SBATCH --error=error100_100_100_100_%j.txt    # Save error messages to a file named error_<job_id>.txt
...
python model_all_100_100_100_100.py
