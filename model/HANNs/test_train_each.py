...
for chr_folder in chromosomes:
    ...
    model_save_dir = os.path.join(input_dir, 'HANNs_test_train_each_', chr_folder)
    ...
    def create_gb_model():
        model = MLPClassifier(hidden_layer_sizes=((100,100)), max_iter=200, random_state=42)
        return model
...
print(ROCAUCs)
with open(os.path.join(input_dir, 'HANNs_test_train_each_', "ROCAUC.pkl"), "wb") as f:
