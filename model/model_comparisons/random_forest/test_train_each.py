...
for learning_rate in learning_rates:
    for chr_folder in chromosomes:
        ...
        model_save_dir = os.path.join(input_dir, 'random_forest_real_test_train_each_hyperparameter_maxDepth_'+str(learning_rate), chr_folder)
        ...
        def create_gb_model():
            model = RandomForestClassifier(n_estimators=100, random_state=42,max_depth=learning_rate)
            return model
