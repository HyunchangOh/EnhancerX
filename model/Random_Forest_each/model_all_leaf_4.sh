#!/bin/bash
#SBATCH --job-name=RF_L4
#SBATCH --output=outputleaf4_%j.txt  # Save output to a file named output_<job_id>.txt
#SBATCH --error=errorLeaf4_%j.txt    # Save error messages to a file named error_<job_id>.txt
