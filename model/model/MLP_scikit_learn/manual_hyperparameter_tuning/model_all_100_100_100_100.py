...
model_save_dir = os.path.join(input_dir, 'HANNs_100_100_100_100', chr_folder)
...
def create_gb_model():
    model = MLPClassifier(hidden_layer_sizes=((100,100,100,100)), max_iter=200, random_state=42)
    return model
