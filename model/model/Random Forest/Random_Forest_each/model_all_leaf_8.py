...
model_save_dir = os.path.join(input_dir, 'random_forest_each_leaf8', chr_folder)
...
def create_gb_model():
    model = RandomForestClassifier(n_estimators=100, random_state=42,min_samples_leaf=8)
    return model
