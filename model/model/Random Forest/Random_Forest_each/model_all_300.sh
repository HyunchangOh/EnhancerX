#!/bin/bash
#SBATCH --job-name=RF_300
#SBATCH --output=output_300_%j.txt  # Save output to a file named output_<job_id>.txt
#SBATCH --error=error300_%j.txt    # Save error messages to a file named error_<job_id>.txt
