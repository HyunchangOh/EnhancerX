#!/bin/bash
#SBATCH --job-name=RF_L2
#SBATCH --output=outputleaf2_%j.txt  # Save output to a file named output_<job_id>.txt
#SBATCH --error=errorLeaf2_%j.txt    # Save error messages to a file named error_<job_id>.txt
