# Train on subsampled for each chromosome
# Test on all binned samples for every other chromosome
...
model_save_dir = '../../../../../scratch/ohh98/models/gradient_boosting/each_chromosome_all_data/'
...
for train_idx, train_chr in enumerate(chromosomes):
    ...
    for test_idx, test_chr in enumerate(chromosomes):
        ...
        X_test, y_test = load_data(all_sample_input_dir,test_chr)
