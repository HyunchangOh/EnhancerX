#!/bin/bash
#SBATCH --job-name=GB_L4
#SBATCH --output=outputGBL4_%j.txt  # Save output to a file named output_<job_id>.txt
#SBATCH --error=errorGBL4_%j.txt    # Save error messages to a file named error_<job_id>.txt
