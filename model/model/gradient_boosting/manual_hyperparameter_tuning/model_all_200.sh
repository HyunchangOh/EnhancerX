#!/bin/bash
#SBATCH --job-name=GB_200
#SBATCH --output=outputGB200_%j.txt  # Save output to a file named output_<job_id>.txt
#SBATCH --error=errorGB200_%j.txt    # Save error messages to a file named error_<job_id>.txt
