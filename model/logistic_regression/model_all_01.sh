#!/bin/bash
#SBATCH --job-name=LR_0_1
#SBATCH --output=output0_1_%j.txt  # Save output to a file named output_<job_id>.txt
#SBATCH --error=error0_1_%j.txt    # Save error messages to a file named error_<job_id>.txt
