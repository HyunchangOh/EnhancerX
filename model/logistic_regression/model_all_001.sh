#!/bin/bash
#SBATCH --job-name=LR_001
#SBATCH --output=output00_1_%j.txt  # Save output to a file named output_<job_id>.txt
#SBATCH --error=error00_1_%j.txt    # Save error messages to a file named error_<job_id>.txt
