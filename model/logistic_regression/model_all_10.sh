#!/bin/bash
#SBATCH --job-name=LR_10
#SBATCH --output=output10_%j.txt  # Save output to a file named output_<job_id>.txt
#SBATCH --error=error10_%j.txt    # Save error messages to a file named error_<job_id>.txt
