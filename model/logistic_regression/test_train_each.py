...
for chr_folder in chromosomes:
    ...
    model_save_dir = os.path.join(input_dir, 'logistc_regression_test_train_each_', chr_folder)
...
print(ROCAUCs)
with open(os.path.join(input_dir, 'logistc_regression_test_train_each_', "ROCAUC.pkl"), "wb") as f:
