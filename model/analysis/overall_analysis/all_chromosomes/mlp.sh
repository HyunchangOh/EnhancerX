...
#SBATCH --output=outputMLP%j.txt  # Save output to a file named output_<job_id>.txt
#SBATCH --error=errorMLP_%j.txt    # Save error messages to a file named error_<job_id>.txt
