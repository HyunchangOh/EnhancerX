...
for learning_rate in learning_rates:
    for chr_folder in chromosomes:
        ...
        model_save_dir = os.path.join(input_dir, 'gradient_boosing200_test_train_each_hyperparameter_learningRate_'+str(learning_rate), chr_folder)
        ...
        def create_gb_model():
            model = GradientBoostingClassifier(n_estimators=200, random_state=42,learning_rate=learning_rate)
            return model
