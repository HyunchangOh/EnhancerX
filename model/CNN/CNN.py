...
result_list1 = []
print("\n-------------------  Trying learning rates -------------------\n")
for i in [0.001, 0.0001, 0.00001]:
    cur_result = custom_run("chr1", feature_dist, lrn_rate = i, structures = structures, f_list = "feature_dist")
    result_list1.append(cur_result)
...
print("\n-------------------  Trying batch size  -------------------\n")
for i in [32, 64, 128]:
    cur_result = custom_run("chr1", feature_dist, batch_size = i, structures = structures, f_list = "feature_dist")
    result_list1.append(cur_result)
...
print("\n-------------------  Trying num_epochs  -------------------\n")
for i in [5, 10, 15]:
    cur_result = custom_run("chr1", feature_dist, num_epochs = i, structures = structures, f_list = "feature_dist")
    result_list1.append(cur_result)
...
print("\n---------------------------------------------------------------------------\n")
print("\nEnd of program, ran mix + mem + dist feature batches for %s seconds" % round(time.time() - omni_time))
print("\n---------------------------------------------------------------------------\n")
"""