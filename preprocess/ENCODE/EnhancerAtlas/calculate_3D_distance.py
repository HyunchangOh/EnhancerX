...
link_source = "../../../../../../scratch/ohh98/data/3DIV/GM12878_in-situ_Mbol_HiCaptureSeq_GMiM_cutoff_10.tsv"
...
for i in range(24):
    ...
    array = np.load(path+c+"/enhancer_atlas.npy")
    distances = dijkstra_1d_with_links(array, links[i])
    np.save(path+c+"/enhancer_atlas_3D_Dist.npy",distances)
