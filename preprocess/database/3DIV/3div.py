...
f = open("../../../../../scratch/ohh98/data/3DIV/GM12878_in-situ_Mbol_HiCaptureSeq_GMiM_cutoff_10.tsv","r")
f.readline()
import numpy as np
...
for l in f.readlines():
    ...
    chromosome = chromosome_converter[l[-3]]
    forwards[chromosome][start] = True
    forwards[chromosome][end] = True

path = "../../../../../scratch/ohh98/la_grande_table/"
for i in range(len(list(chromosome_converter.keys()))):
    np.save(path+list(chromosome_converter)[i]+"/Interaction.npy",forwards[i])